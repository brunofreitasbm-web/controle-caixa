...
// Script C# simples e limpo compilado/executado via PowerShell script file
const psScript = `
...
function Generate-PngIcon($outFile, $canvasSize) {
    ...
    $c1 = [System.Drawing.Color]::FromArgb(255, 255, 255, 255)
    $c2 = [System.Drawing.Color]::FromArgb(255, 245, 239, 230)
    ...
    # Gold gradient border & accent (dark chocolate for light theme)
    $gc1 = [System.Drawing.Color]::FromArgb(255, 74, 18, 26)
    $gc2 = [System.Drawing.Color]::FromArgb(255, 31, 5, 8)
    $goldBrush = New-Object System.Drawing.Drawing2D.LinearGradientBrush $rect, $gc1, $gc2, 45.0
    
    $penWidth = [Math]::Max(3.0, ([float]($canvasSize * 0.03)))
    ...
    $innerColor = [System.Drawing.Color]::FromArgb(255, 253, 251, 247)
    ...
    # Display Top Trap
    $p1 = New-Object System.Drawing.PointF ([float]($canvasSize * 0.36)), $ry
    $p2 = New-Object System.Drawing.PointF ([float]($canvasSize * 0.40)), ([float]($canvasSize * 0.17))
    $p3 = New-Object System.Drawing.PointF ([float]($canvasSize * 0.60)), ([float]($canvasSize * 0.17))
    $p4 = New-Object System.Drawing.PointF ([float]($canvasSize * 0.64)), $ry
    ...
    # Dollar sign
    $fontDollar = New-Object System.Drawing.Font -ArgumentList 'Trebuchet MS', ([float]($canvasSize * 0.15)), ([System.Drawing.FontStyle]::Bold)
    $sf = New-Object System.Drawing.StringFormat
    $sf.Alignment = [System.Drawing.StringAlignment]::Center
    $sf.LineAlignment = [System.Drawing.StringAlignment]::Center
    $dollarBox = New-Object System.Drawing.RectangleF 0, ([float]($canvasSize * 0.34)), $canvasSize, ([float]($canvasSize * 0.2))
...
fs.writeFileSync(path.join(__dirname, 'gen_png.ps1'), psScript);
console.log('ps1 file written successfully');
